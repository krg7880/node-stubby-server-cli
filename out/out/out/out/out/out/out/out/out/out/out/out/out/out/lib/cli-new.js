                        ...
                        System.registerModule("../../lib/cli-new.js", [], function() {
                          ...
                          System.registerModule("../../lib/cli-new.js", [], function() {
                            ...
                            var _spawn = function() {
                              ...
                              stream.split('\n');
                              stream.on('split', function onSplit(chunk, token) {
                                var line = chunk.toString();
                                if (line.indexOf('<-') > -1) {
                                  this._private(self).__onResponse(line);
                                } else {
                                  this._private(self).__onRequest(line);
                                }
                              });
